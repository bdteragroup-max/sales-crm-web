...
import { createMaterialRequisition } from '@/app/actions/requisitions';
...
export default function RequisitionForm({ users, currentUser }: { users: UserOption[], currentUser: any }) {
