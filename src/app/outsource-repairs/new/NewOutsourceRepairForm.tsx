...
export default function NewOutsourceRepairForm({ users, currentUserId }: { users: UserOption[], currentUserId: string }) {
  ...
  const handleSubmit = async (action: "save" | "print") => {
    ...
    try {
      ...
      const result = await createOutsourceRepair(formData);
