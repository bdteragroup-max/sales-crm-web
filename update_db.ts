...
async function main() {
  ...
  try {
      ...
      await prisma.$executeRawUnsafe(`ALTER TABLE "ProjectEquipment" ADD CONSTRAINT "ProjectEquipment_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "Project"("id") ON DELETE CASCADE ON UPDATE CASCADE;`);
  } catch(e) {
      console.error("FK creation skipped or failed:", e);
  }
